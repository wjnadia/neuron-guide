...
**3)  Username 및 Password(CLI secret) 확인**

프로젝트가 private으로 지정된 경우, 프로젝트에  컨테이너  이미지를  업로드  및 다운로드하기 위해서는 컨테이너 플랫폼에서 Username 및 Password를 입력하여 인증 정보를 등록(로그인) 해 주어야 합니다. User Profile에서 Username과 Password를 확인할 수 있으며,  Username은  동일하며 CLI secret이 Password에  해당합니다. &#x20;

<figure><img src="../.gitbook/assets/image (10).png" alt=""><figcaption><p>User Profile</p></figcaption></figure>

podman, singularity의 터미널 화면에서 아래와 같이 myhub에 대한 로그인 인증 정보를 등록할 수 있습니다.  Password(Token)는 입력을 해도 화면에 표기되지 않습니다.&#x20;
