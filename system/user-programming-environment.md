...
|                                    구분                                    |                                                                                                                                                                                                                                                                                             항목                                                                                                                                                                                                                                                                                            |
| :----------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                   컴파일러                                   |                                                                                                                                                                                                                                 <ul><li>gcc/11.5.0</li><li>gcc/15.2.0</li><li>intel/25.3.0</li><li>nvhpc/25.11_cuda12</li><li>nvhpc/25.11_cuda13</li></ul>                                                                                                                                                                                                                                |
|                                 MPI 라이브러리                                |                                                                                                                                                                                                                                                  <ul><li>mpi/openmpi-4.1.8</li><li>mpi/impi-21.17</li><li>cudampi/openmpi-4.1.8</li></ul>                                                                                                                                                                                                                                                 |
|                                   라이브러리                                  |                                                                                                                                                                                                                    <ul><li>mkl/2025.3</li><li>lapack/3.12.1</li><li>netcdf/4.9.3</li><li>hdf5/2.0.0</li><li>fftw3/3.3.10</li><li>cudss/0.7.1</li><li>aocl/5.2</li></ul>                                                                                                                                                                                                                   |
|                                CUDA 라이브러리                                |                                                                                                                                                                                                                                                           <ul><li>cuda/12.4.1</li><li>cuda/12.9.1</li><li>cuda/13.0.2</li></ul>                                                                                                                                                                                                                                                           |
|                                   소프트웨어                                  |                                                                                                                            <ul><li>R/4.5.2</li><li>cmake/4.2.1</li><li>gaussian/g16</li><li>gaussian/g16.b01</li><li>gaussian/g16.c01</li><li>gaussian/g16.c02</li><li>git-lfs/3.6.1</li><li>git/2.52.0</li><li>htop/3.4.1</li><li>nvtop/3.2.0</li><li>java/openjdk-25.0.1</li><li>python/3.14.2</li><li>singularity/4.1.0</li><li>singularity/4.3.4</li></ul>                                                                                                                            |
...
|                               conda 패키지 환경                               |                                                                                                                                                                                                        <ul><li>conda/pytorch_2.5.0</li><li>conda/pytorch_2.9.1_cuda12</li><li>conda/pytorch_2.9.1_cuda13</li><li>conda/tensorflow_2.16.1</li><li>conda/tensorflow_2.20.0</li></ul>                                                                                                                                                                                                        |
| <p>AArch64 아키텍처 <br><mark style="color:red;">(gh200_1 파티션 전용)</mark></p> | <ul><li>ARM_acfl/24.10.1</li><li>ARM_armpl/24.10.1</li><li>ARM_cmake/3.26.2</li><li>ARM_cuda/12.3</li><li>ARM_cudampi/mvapich2-2.3.6</li><li>ARM_cudampi/openmpi-4.1.1</li><li>ARM_fftw_mpi/3.3.7</li><li>ARM_gcc/11.4.1</li><li>ARM_go/1.24.1</li><li>ARM_gromacs/2023.3</li><li>ARM_gromacs/2024.4</li><li>ARM_htop/3.0.5</li><li>ARM_lammps/2Aug2023</li><li>ARM_lammps/23Jun2022</li><li>ARM_nvidia_hpc_sdk/23.11</li><li>ARM_nvidia_hpc_sdk/24.1</li><li>ARM_nvidia_hpc_sdk/24.5</li><li>ARM_nvtop/1.1.0</li><li>ARM_python/3.12.4</li><li>ARM_qe/7.3</li><li>ARM_qe/7.3.1</li></ul> |

* conda module은 pytorch/tensorflow 사용을 위한 라이브러리가 환경설정되는 module 입니다.
...
<mark style="color:red;">**※ GPU가 장착되지 않은 CPU 노드에서는 None CUDA MPI 라이브러리(예 :  mpi/openmpi-4.1.1) 모듈을 사용해야 합니다.**</mark>
...
혹은
$ ml -[module name] -[module name] -[module name] ...     
ex) ml -gcc/15.2.0 -singularity/4.3.4
```
...
```shell-session
$ module load gcc/15.2.0 cuda/12.4.1 cudampi/openmpi-4.1.8
$ mpicc -c mpi-cuda.c -o mpi-cuda.o
$ mpicc mpi-cuda.o -lcudart -L/apps/cuda/11.4/lib64
$ srun ./a.out
```

※ intel 컴파일러 사용 시, gcc/15.2.0 대신 intel/25.3.0 module을 load을 적용합니다.<br>
